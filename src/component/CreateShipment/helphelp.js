...
async function updateBatch(id, name, email, phone, address, setModalIsOpenEdit, getBatchList) {
  if (name !== "" && email !== "" && phone !== "" && address !== "") {
    ...
    document.getElementById("edit-validate-batch").innerHTML = "*Please fill required fields!";
    ...
    <section class="homedive ">
      ...
      <Modal isOpen={modalIsOpenEdit} className='main_modal_body dispatcher-list-form'>
        ...
        <Form className='form_main '>
          ...
          <FormGroup>
            <Input type="number" name="phone" id="phone" placeholder="Edit Phone Number" onChange={(e) => setPhone(e.target.value)} value={phone} />
          </FormGroup>
          <FormGroup>
